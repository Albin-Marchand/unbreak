  ...
  <div class="h-full flex flex-col justify-around">
    <div class="h-full flex flex-col justify-between lg:justify-start">
      <div class="w-full flex justify-center">
        ...
        >
          <span>Calculez votre distance de course en un clin d’oeil.</span>
          <span
            >Il vous suffit de rentrer votre allure de course et votre temps
            cible et le tour est joué !</span
          >
        </p>
      </div>
      <h1
      ...
      >
        Calculez la distance de votre course
      </h1>
        ...
        >
          ...
          >
            ...
            <div class="w-full max-w-sm lg:w-96">
              <label for="distance">Allure par kilometre </label>
              <input
                @click="ResetDistance()"
  ...
  objParametersRunningCalculator.value.result = {
    ...
    pace:
      isNaN(paceMinutes) && isNaN(paceSeconds)
        ? 0 + "min/km"
        : `${paceMinutes}'${
            paceSeconds.toString().length > 1 ? paceSeconds : "0" + paceSeconds
          }" min/km`,
  };
}
